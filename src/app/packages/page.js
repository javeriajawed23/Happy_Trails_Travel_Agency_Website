...
export default function PackagesPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative w-full h-[50vh] bg-gradient-to-r from-blue-500 to-cyan-500">
        ...
        <div className=" relative h-full flex flex-col justify-center items-center px-4 md:px-10 py-12 text-center text-white">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-3xl">
            Curated adventures for every traveler. Discover your perfect journey.
          </p>
        </div>
      </section>
        ...
        <div className="px-4 md:px-10">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Popular travel experiences handpicked for value and unforgettable memories
            </p>
          </div>
              ...
              >
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex items-center bg-gray-100 px-2 py-1 rounded text-sm font-medium text-blue-700">
      ...
      <section className="py-16 bg-gray-50">
        <div className="px-4 md:px-10">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Browse our complete collection of expertly crafted travel experiences
            </p>
          </div>
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      className="border-blue-600 cursor-pointer text-blue-600 hover:bg-blue-50"
                    >
                      View Details
                    </Button>
                  </div>
      ...
      <section className="py-16 bg-blue-50">
        <div className="px-4 md:px-10">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Hear from adventurers who joined our packages
            </p>
          </div>
        ...
        <div className="px-4 md:px-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Our travel experts are ready to help you plan an unforgettable trip
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-blue-600 hover:bg-white/90 text-base cursor-pointer"
              >
                Browse All Packages
              </Button>
              <Button
...
const travelStyles = [
  ...
  },
  {
    id: "adventure",
    name: "Adventure",
    description: "Thrill-seekers and active travelers",
    image: "/adventure.jpg",
  },
  {
    id: "family",
