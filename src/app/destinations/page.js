            ...
            {allDestinations.map((destination, index) => (
              ...
              >
                <div className="relative h-64 w-full">
                  ...
                  />
                  <div className="absolute top-2 right-2 bg-white/90 px-2 py-1 rounded text-sm font-medium text-blue-700 flex items-center">
          ...
          <div className="flex justify-center mt-12">
            <div className="flex gap-2">
              <Button
                variant="outline"
                size="icon"
                className="w-10 h-10 rounded-md border-blue-500 text-blue-500 cursor-pointer"
              >
                1
              </Button>
              <Button
        ...
        <div className="px-4 md:px-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-blue-600 cursor-pointer text-base hover:bg-blue-700"
              >
